    ...
    <div className="contact-sectionn">
     <img
      ...
      <div className='contact-textt'>
        <span className='contact-black-textt'>आपला अभिप्राय </span>
        <span className='contact-orange-textt' >आम्हाला कळवा</span>
        </div>
      ...
      <div className="form-groupp full-widthh">
        <img src={msg} />
        <textarea placeholder="संदेश"></textarea>
      </div>
      </div>
       <div className='btnn'>
        <button type="submitt">अभिप्राय पाठवा</button>
        </div>
        </form>
        <div className='map-backk'>
<div className='map-headingg'>
  <span className='map-heading-greyy'>"गाव जिथे शब्द रुजतात –</span>
  <span className='map-heading-orangee'> माझं कवितांचं गाव जकातवाडी </span>
</div>
...
<div className='note-mainn'>
      <div className="note-sectionn">
      <span className='note-black-textt'>सभासद</span>
      <span className='note-orange-textt'> नोंदणी</span>
</div>
        <ul>
          <li className='note-listt'>नोंदणी करा आणि या कवितेच्या प्रवाहात सामील व्हा!</li>
        </ul>
      ...
      <div className='orangee'>
        ...
        <img className='note-imgg' src={note} />
