  ...
  return (
    <div className="purvkaryakram-container">
      ...
      <div className="purvkaryakram-event-grid">
        ...
        <div className="purvkaryakram-view-all-button">
        <a href="/events" className="purvkaryakram-btn order_now btn_Brand">
        <Link to="/AnswerTwo" className="purvkaryakram-btn order_now btn_Brand">View All</Link>
