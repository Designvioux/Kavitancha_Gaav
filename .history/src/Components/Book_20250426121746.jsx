    ...
    <div className="book-container">
      ...
      <div className="book-main">
        <div className="book-pages-wrapper">
          <div className="book-page"><h5>भारतातील पहिलं</h5> <br></br><h4>माझं कवितांचं गांव</h4> <h6>
          जकातवाडी राजधानी सातारा</h6></div>
          <div className="book-page">
            <h2>कणा </h2>
            <p>ओळखलंत का सर मला?" पावसात आला कोणी,
...
पाठीवरती हात ठेवून नुसते लढ म्हणा.</p>
          </div>
