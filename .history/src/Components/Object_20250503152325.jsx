...
const AamchaSahityaSection = () => {
  return (
    <section className="aamcha-section">
      ...
      <p className="aamcha-description">
        कविता विभाग हा भावनांचा, विचारांचा आणि अभिव्यक्तीचा अवकाश आहे...
      </p>

      {/* Horizontal Scroll Container */}
      <div className="aamcha-content">
        <div className="aamcha-content-scroll">

          {/* Card 1 */}
          <div className="aamcha-card-wrapper">
            <div className="aamcha-image">
              <img src={ebook} alt="ई-बुक" />
            </div>
            <div className="aamcha-card">
              <h3 className="ebook-title">ई – बुक</h3>
              <p className="ebook-desc">
                कवितांचं गाव प्लॅटफॉर्मवर खास मराठी कवींसाठी curated ई-पुस्तकांचा संग्रह...
              </p>
              <div className="ebook-buttons">
                <Link className="read-button" to="/Ebook">वाचा</Link>
                <button className="download-button">Download</button>
          ...
          <div className="aamcha-card-wrapper">
            ...
            <div className="aamcha-card">
              <h3 className="ebook-title">दिवाळी अंक</h3>
              <p className="ebook-desc">
                प्रत्येक वर्षी प्रकाशित होणारा खास दिवाळी अंक म्हणजे नव्या प्रतिभेला वाव...
              </p>
              <div className="ebook-buttons">
                <Link className="read-button" to="/Diwali">वाचा</Link>
                <button className="download-button">Download</button>
          ...
          <div className="aamcha-card-wrapper">
            ...
            <div className="aamcha-card">
              <h3 className="ebook-title">मासिक</h3>
              <p className="ebook-desc">
                प्रत्येक महिन्यात प्रकाशित होणारं आमचं खास साहित्यिक मासिक...
              </p>
              <div className="ebook-buttons">
                <Link className="read-button" to="/Masik">वाचा</Link>
                <button className="download-button">Download</button>
