...
import ContactPop from './Components/PageComponents/ContactUs/ContactPop.jsx';
...
function App() {
 ...
 <Router>
    ...
    <Routes>
      ...
      <Route path="/ContactPop" element={<ContactPop/>}/>
      <Route path="/SuccessPopup" element={<ContactUs/>}/>
    </Routes>
    <Footer/>
  </Router>
