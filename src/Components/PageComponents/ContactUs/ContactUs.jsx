...
const ContactUs = () => {
  // Inline styles for framer effect
  const sectionStyle = {
    position: 'relative',
    padding: '30px',
    border: '10px solid #D4AF37',  // Golden border
  ...
  const formStyle = {
    ...
    boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)', // Shadow for form
  };

  const mapStyle = {
    marginTop: '30px',
    padding: '20px',
    border: '3px solid #48C9B0', // Teal border
    borderRadius: '10px',
  ...
  const noteStyle = {
    ...
    borderRadius: '10px',
    border: '3px solid #FFD700', // Golden border
    boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)', // Shadow
  };

  return (
    <div className="contactus-section" style={sectionStyle}>
      <img src={img} alt="Library" className="contactus-background-image" />
      <div className="contactus-overlay-text">
        <h1>संपर्क करा</h1>
      </div>

      <form className="contactus-form" style={formStyle}>
      ...
      <div className="contactus-map-section" style={mapStyle}>
      ...
      <div className="contactus-note-section" style={noteStyle}>
